...
class GPTConfig:
    ...
    vocab_size: int =  50304 # 50257 vocabulary size, e.g. GPT-2 has 50257 tokens
...
class DataLoaderLite:
    ...
    def __init__(self, B, T):
        ...
        with open('data/text-data/input.txt', 'r') as f:
            text = f.read()
...
B = 16
T = 1024
assert total_batch_size % ( B * T ) == 0, "the total batch size shoudl be divisible by B * T"
grad_accum_steps = total_batch_size // (B * T) # 32k / (16 * 1024) = 32
